...
BigInteger.prototype.longValue = function(b) {
  return bnToString.call(this, b);
}
...
function sha512(s) {                      // Requires jsSHA
  var shaObj = new jsSHA512(s, "ASCII");
  return bi2bytes(hex2bi(shaObj.getHash("SHA-512", "HEX")), 64).reverse();
//  return Crypto.SHA256(s, {asString: true})
}
